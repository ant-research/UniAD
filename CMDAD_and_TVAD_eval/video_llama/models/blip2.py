...
class Blip2Base(BaseModel):
    ...
    def init_tokenizer(cls):
        tokenizer = BertTokenizer.from_pretrained("/home/whl/AutoAD_stage2/Video-LLaMA/bert-base-uncased")
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        encoder_config = BertConfig.from_pretrained("/home/whl/AutoAD_stage2/Video-LLaMA/bert-base-uncased")
